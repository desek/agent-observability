...
## [0.2.0](https://github.com/desek/agent-observability/compare/pi-mlflow-tracing-v0.1.0...pi-mlflow-tracing-v0.2.0) (2026-08-13)


### ⚠ BREAKING CHANGES

* **config:** PI_OTEL_ENABLE is renamed to PI_AGENT_ENABLE_TELEMETRY with no alias. Existing users must update the variable name.

### Features

* **config:** observability.json config file + align telemetry switch with Claude Code ([#11](https://github.com/desek/agent-observability/issues/11)) ([5f96d2a](https://github.com/desek/agent-observability/commit/5f96d2a9e190da0ef57475f6a1ac107c96e6c1f5))
